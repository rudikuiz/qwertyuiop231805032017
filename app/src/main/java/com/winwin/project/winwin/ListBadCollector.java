...
public class ListBadCollector extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_bad_collector);
        ...
        requestQueue = Volley.newRequestQueue(ListBadCollector.this);

        loading = new OwnProgressDialog(ListBadCollector.this);
        ...
        stringRequest = new StringRequest(Request.Method.GET, URL_GET_ALL + member_id, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    AdapterListBad adapter = new AdapterListBad(listData, ListBadCollector.this);
            ...
            public void onErrorResponse(VolleyError error) {
                if (error instanceof TimeoutError) {
                    Toast.makeText(ListBadCollector.this, "timeout", Toast.LENGTH_SHORT).show();
                } else if (error instanceof NoConnectionError) {
                    Toast.makeText(ListBadCollector.this, "no connection", Toast.LENGTH_SHORT).show();
                }
